...
(8, 'Brown Sugar', 15.0),
(8, 'Rice Vinegar', 15.0),
(9, 'Lasagna Noodles', 300.0),
(9, 'Ricotta Cheese', 200.0),
(9, 'Spinach', 150.0),
(10, 'Tomatoes', 400.0),
(10, 'Fresh Mozzarella', 200.0),
(10, 'Basil', 20.0),
(10, 'Olive Oil', 30.0),
(10, 'Balsamic Glaze', 15.0),
(10, 'Salt', 5.0),
(10, 'Black Pepper', 5.0),
(11, 'Salmon Fillets', 500.0),
(11, 'Soy Sauce', 50.0),
(11, 'Mirin', 30.0),
(11, 'Brown Sugar', 15.0),
(11, 'Ginger', 1.0),
(12, 'Spaghetti', 400.0),
(12, 'Tomatoes', 300.0),
(12, 'Fresh Mozzarella', 200.0),
(12, 'Basil', 20.0),
(13, 'Beef Tenderloin', 800.0),
(13, 'Puff Pastry', 200.0),
(13, 'Mushrooms', 150.0),
(13, 'Prosciutto', 100.0),
(13, 'Dijon Mustard', 15.0),
(14, 'Pizza Dough', 400.0),
(14, 'Chicken Breast', 300.0),
(14, 'Alfredo Sauce', 200.0),
(14, 'Mozzarella Cheese', 200.0),
(15, 'Shrimp', 300.0),
(15, 'Avocado', 2.0),
(15, 'Cherry Tomatoes', 150.0),
...
(3, 4, 'Garlic', 'Mince garlic and add to the shrimp. Cook for an additional 2 minutes.', 5, 2),
(4, 4, 'Lemon Juice', 'Squeeze lemon juice over the shrimp and garlic mixture.', 5, 0),
...
(3, 6, 'Mozzarella Cheese', 'Sprinkle mozzarella cheese over the pizza. Cook in oven at high temp (400+ degrees) until crust is golden brown.', 5, 15),
...
(3, 7, 'Oil', 'Heat oil in a pan and sear marinated chicken until golden brown.', 10, 15),
(4, 7, 'Onions', 'Add finely chopped onions to the pan and sauté until golden brown.', 10, 5),
(5, 7, 'Tomato Paste', 'Stir in tomato paste and cook for 2-3 minutes.', 1, 3),
(6, 7, 'Garam Masala', 'Add garam masala and continue cooking for another 2 minutes.', 1, 2),
(7, 7, 'Tomatoes', 'Add chopped tomatoes and cook until the oil separates from the masala.', 5, 10),
(8, 7, 'Cream', 'Pour in heavy cream and simmer for 10-15 minutes until the sauce thickens.', 5, 15),
(9, 7, 'Cilantro', 'Garnish with chopped cilantro before serving.', 5, 0),
(1, 8, 'Beef Sirloin', 'Slice beef sirloin thinly for stir-frying.', 15, 0),
(2, 8, 'Broccoli', 'Cut broccoli into florets for the stir-fry.', 10, 0),
(3, 8, 'Oil', 'Stir-fry beef and broccoli in choice of oil.', 10, 5),
(4, 8, 'Ginger', 'Finely chop ginger for the stir-fry.', 5, 0),
(5, 8, 'Garlic', 'Mince garlic for the stir-fry.', 5, 0),
(6, 8, 'Sesame Oil', 'Add sesame oil to a hot wok or pan.', 5, 0),
(7, 8, 'Beef Sirloin', 'Stir-fry sliced beef until browned. Remove from the pan.', 15, 0),
...
(10, 8, 'Cornstarch', 'Dissolve cornstarch in water and add to the stir-fry for thickness.', 5, 3),
(11, 8, 'Garlic', 'Add minced garlic and stir-fry for an additional 2 minutes.', 5, 2),
(12, 8, 'Sesame Seeds', 'Garnish with sesame seeds before serving.', 2, 0),
(1, 9, 'Lasagna Noodles', 'Boil lasagna noodles until al dente.', 10, 0),
(2, 9, 'Ricotta Cheese', 'Spread ricotta cheese (or vegan cheese) over the cooked lasagna noodles.', 5, 0),
...
(2, 10, 'Fresh Mozzarella', 'Slice fresh mozzarella into rounds.', 5, 0),
...
(7, 10, 'Black Pepper', 'Add freshly ground black pepper.', 1, 0),
(1, 11, 'Salmon Fillets', 'Marinate salmon fillets in a mixture of soy sauce, mirin, brown sugar, and ginger for 30 minutes.', 30, 0),
...
(1, 12, 'Spaghetti', 'Cook spaghetti according to package instructions.', 10, 0),
...
(1, 13, 'Beef Tenderloin', 'Sear beef tenderloin on high heat until browned on all sides.', 10, 0),
(2, 13, 'Mushrooms', 'Saute mushrooms in the same pan until golden brown.', 5, 5),
(3, 13, 'Prosciutto', 'Layer prosciutto over the beef tenderloin.', 5, 0),
...
(3, 14, 'Mozzarella Cheese', 'Top the pizza with chicken strips and mozzarella cheese.', 5, 15),
